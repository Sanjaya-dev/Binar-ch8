                ...
                <div className="container testimoni text-center" id="Testimonial">
                    ...
                    <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                        ...
                        <div className="button_testimoni">
                            <a type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev" className="testimonial-media"><img
                                src="/Left button.png" alt=""/></a>
                            <a type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next" className="testimonial-media"><img
